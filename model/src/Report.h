...
private:
  ...
  string outputGeneticsFile;
  string outputSprayFile;
  string outputMozAgesFile;
  string outputBitesFile;
  string outputUniqueBitesFile;
  ...
  unordered_map<int, unordered_map<string, unordered_map<string, int>>> dailyFemaleGenetics;
  unordered_map<int, unordered_map<string, unordered_map<string, double>>> dailyMaleGenetics;
  unordered_map<string, unordered_map<int, vector<string>>> dailySprayLocs;
  unordered_map<string, unordered_map<int, int>> spray_counts;
  unordered_map<int, int> mosquito_counts;
  unordered_map<int,int> human_counts;
  unordered_map<string,unordered_map<int,int>> dailyOutbreakResponseSymp;
  unordered_map<string,unordered_map<int,int>> dailyOutbreakResponseLocations;
  unordered_map<int,int> dailyZeroMozLocations;
  unordered_map<int,int> dailyBites;
  unordered_map<int, unordered_map<int, int>> mozUniqueBites;
...
public:
  ...
  void printGeneticsReport(int);
  void printSprayReport(int);
  void printBitesReport(int);
  void printSpatialReport(int);
  void printMozAgesReport(int);
  void printMozUniqueBitesReport(int);
  void updateSprayReport(int, string, string);
  void updateBitesReport(int,int);
  ...
  void updateFemaleGeneticsReport(int, string, string);
  void updateMaleGeneticsReport(int, string, string, double);
  void updateMozUniqueBitesReport(int, Mosquito *);
  void addOutbreakSymptomatic(int , Human *, bool, string);
  void addOutbreakResponseLocations(int , Location *, string);
